"""
Scene 1: VAE Fundamentals & Metric Extraction (Efficient)
========================================================

Efficient slide-based scene with fewer, longer animations.
"""
...
class VAEMetricExtractionEfficient(Slide):
    """Efficient VAE scene with fewer, longer animations."""
    ...
    def construct(self):
        """Construct the efficient VAE scene."""
        ...
        # SLIDE 2: VAE Pipeline (Single Animation)
        self.play(FadeOut(title_group, shift=UP), run_time=1)
        
        # Create all components at once (no individual animations)
        ...
        # SLIDE 3: Metric Extraction Highlight (Single Animation)
        ...
        # SLIDE 4: Metric Extraction Process (Single Animation)
        ...
        # SLIDE 5: K-means Visualization (Single Animation)
