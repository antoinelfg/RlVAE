"""
Scene 1: VAE Fundamentals & Metric Extraction (Slide Version)
============================================================

Slide-based scene that works without video output.
"""
...
class VAEMetricExtractionSlides(Slide):
    """Slide-based VAE scene that works without video."""
    ...
    def construct(self):
        """Construct the slide-based VAE scene."""
