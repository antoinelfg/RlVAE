...
class VanillaVAETraining(Slide):
...
class FullGUGUSPresentation(Slide):
    def construct(self):
        # Section 1: Vanilla VAE Training
        VanillaVAETraining.construct(self)
        self.next_slide()  # Optional: extra slide break between sections

        # Section 2: KMeans Metric Visualization
        KMeansMetricVisualization.construct(self)
        self.next_slide()

        # Section 3: GUGUS Reconstruction Pipeline
        GUGUSReconstructionPipeline.construct(self)
        self.next_slide()

        # Section 4: GUGUS Training Pipeline
        GUGUSTrainingPipeline.construct(self)
        self.next_slide()